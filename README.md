...
-   **Translated username** --- Your Translated username.
-   **Translated password** --- Your Translated password.
-   **Translate slugs** --- Do you want entry slugs to be translated?
-   **Asset volume** --- Assign a volume to store autogenerated and manually uploaded files.
-   **Sandbox mode** --- Enable the Sandbox mode for testing. Any files submitted with Sandbox mode enabled will not be translated and no transaction will occur. You will be returned the initial file you have supplied.
...
-   **Send notifications** --- Send a notification when a translation file is delivered by translated.
-   **Notification email(s)** --- A comma separated list of email addresses to whom the notification email will be sent.
...
-   **Project Name** --- This will be automatically generated from the entry title, but you can modify it or create your own.
-   **Translation Level** --- Translated provides three levels of service, with different price points that will be reflected in the estimate:
    -   [£] Economy --- Machine Translation with light human review.
    -   [££] Premium --- Human Translation with quality control.
    -   [£££] Professional --- Human Translation with specialist review and quality control.
-   **Source Language** --- Please identify the language of the text to be translated.
-   **Target Language** --- Please identify the language that you want to be supplied.
-   **Genre** --- Select a category that best describes the subject matter of your text to help allocate this to the most appropriate translator.
-   **Word Count** --- This will be automatically generated from the submitted entry, however, if you are uploading your own document then you will need to provide this information.
-   **Notes** --- Provide additional notes to the translator. This will be automatically populated when requesting a translation from an Entry.
-   **Select file to translate** --- Accepted formats include CSV, Word and Text. Your translation will be returned in the same file format.
-   **Content** --- A free text field to provide content.
...
-   **Original entry** --- A link to the original entry.
-   **Level** --- The service level requested for the translation.
-   **Source Language**
-   **Target Language**
-   **Genre**
-   **Word Count** --- An estimate of the total word count.
-   **Notes** --- Any notes added to the order.
-   **Link** --- A link to the CSV file generated by the plugin and submitted to Translated
